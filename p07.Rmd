...
Despite showing no change across trials, target fixation was strongly and consistently above the chance baseline (1/6) at every trial position. All three effect sizes are large, indicating that participants' first saccades were directed toward the target at more than twice the chance rate throughout the sequence.  
