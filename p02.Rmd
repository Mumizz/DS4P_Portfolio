---
title: "Portfolio 2: Contextual Predictability and Word Frequency Effects on Reading Time"
---
...
This portfolio examined the interaction between contextual predictability and word frequency effects on total dwell time during reading. Building upon Portfolio 1, which used ordinary linear regression to investigate word length × frequency interaction, this portfolio employed linear mixed-effects models with random intercepts for participants and paragraphs to appropriately account for the hierarchical structure of the eye-tracking data.
